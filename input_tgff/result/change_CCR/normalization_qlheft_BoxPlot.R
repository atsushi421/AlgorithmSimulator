...
## read data file
d1 <- read.table("./Propose/0.25.txt")
d1 <- d1 / d1_median  # QLHEFT_0.25_median
d2 <- read.table("./Propose/0.5.txt")
d2 <- d2 / d2_median  # QLHEFT_0.5_median
d3 <- read.table("./Propose/1.0.txt")
d3 <- d3 / d3_median  # QLHEFT_1.0_median
d4 <- read.table("./Propose/2.0.txt")
d4 <- d4 / d4_median  # QLHEFT_2.0_median
d5 <- read.table("./Propose/4.0.txt")
d5 <- d5 / d5_median  # QLHEFT_4.0_median
propose <- cbind(d1, d2, d3, d4, d5) # bind data

## read data file
d1 <- read.table("./HEFT/0.25.txt")
d1 <- d1 / d1_median  # QLHEFT_0.25_median
d2 <- read.table("./HEFT/0.5.txt")
d2 <- d2 / d2_median  # QLHEFT_0.5_median
d3 <- read.table("./HEFT/1.0.txt")
d3 <- d3 / d3_median  # QLHEFT_1.0_median
d4 <- read.table("./HEFT/2.0.txt")
d4 <- d4 / d4_median  # QLHEFT_2.0_median
d5 <- read.table("./HEFT/4.0.txt")
d5 <- d5 / d5_median  # QLHEFT_4.0_median
